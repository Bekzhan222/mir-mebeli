...
?>
            ...
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides">
                    <li style="background-image: url('<?php the_field('fott'); ?>" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 class="slider__title"><?php the_field('slovo'); ?></h2>
                    ...
                    <li style="background-image: url('<?php the_field('joto'); ?>" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 style="color: #fff" class="slider__title"><?php the_field('txxx'); ?></h2>
                    ...
                    <li style="background-image: url('<?php the_field('jotoc'); ?>" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2  class="slider__title"><?php the_field('ttt'); ?></h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img src="<?php the_field('about_jpg'); ?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle"><?php the_field('txt'); ?></h2>
                <div class="toys__wrapper">
                    <div class="toys__item" style="background-image: url(<?php the_field('src'); ?>">
                        <div class="toys__item-info">
                            <div class="toys__item-title"><?php the_field('med'); ?></div>
                            <div class="toys__item-descr">
                            <?php the_field('class'); ?>                           
                            </div>
                            <div class="minibutton toys__trigger">200 000 ₸</div>
                        </div>
                    </div>

                    <div class="toys__item" style="background-image: url(<?php the_field('photo'); ?>">
                        <div class="toys__item-info">
                            <div class="toys__item-title"><?php the_field('teext'); ?></div>
                            <div class="toys__item-descr">
                            <?php the_field('class2'); ?>
                            </div>
                            <div class="minibutton toys__trigger">250 000 ₸ </div>
                        </div>
                    </div>

                    <div class="toys__item" style="background-image: url(<?php the_field('phot'); ?>">
                        <div class="toys__item-info">
                            <div class="toys__item-title"><?php the_field('txxt'); ?></div>
                            <div class="toys__item-descr">
                            <?php the_field('classs'); ?></div>
                            <div class="minibutton toys__trigger">100 000 ₸ </div>
                        </div>
                    </div>

                    <div class="toys__item" style="background-image: url(<?php the_field('phoo'); ?>">
                        <div class="toys__item-info">
                            <div class="toys__item-title"><?php the_field('ptp'); ?></div>
                            <div class="toys__item-descr">
                            <?php the_field('clss'); ?>                      
                            </div>
                            <div class="minibutton toys__trigger">85 000 ₸</div>
                        </div>
                    </div>
                    <div class="toys__item" style="background-image: url(<?php the_field('foto'); ?>">
                        <div class="toys__item-info">
                            <div class="toys__item-title"><?php the_field('ptx'); ?></div>
                            <div class="toys__item-descr">
                            <?php the_field('klass'); ?>                          
                            </div>
                            <div class="minibutton toys__trigger">90 000 ₸</div>
                        </div>
                    </div>
                    <div class="toys__item" style="background-image: url(<?php the_field('fhoto'); ?>">
                        <div class="toys__item-info">
                            <div class="toys__item-title"><?php the_field('ttx'); ?></div>
                            <div class="toys__item-descr">
                            <?php the_field('kls'); ?>
                            </div>
                            <div class="minibutton toys__trigger">140 000 ₸</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span>Не нашли то, что искали?</span> Свяжитесь с нами - и мы с радостью создадим любой мебель по вашему желанию. Вы можете выбрать все: размер, материал, формы...!
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('fottx'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('suret'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('kaches'); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('jazu'); ?>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('surrr'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            Мы находимся в г. Шымкент, в центре города "ГККП высший колледж новых технологий"
                            <br> <br>
                            по адресу ул. А.Байтурсынова, 23
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+77002320566"><?php the_field('nubme'); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+77473460830"><?php the_field('numbe'); ?></a>
                                    </div>
                                </div>
                            </div>
